...
<head>
    <title>TapNGo | Admin | Menu | Edit</title>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row">
                                                            <div class="col">
                                                                <form method="POST"
                                                                    action="{{ url('admin/manageMenu/update/' . $menu->menu_id) }}"
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="description" id="description"
                                                                                ...
                                                                                rows="3" style="resize: none;">{{ $menu->description }}</textarea>
                                                                            @error('description')
                                                                                <div class="text-danger">
                                                                                    {{ $message }}
                                                                                </div>
                                                                        ...
                                                                        <div class="form-border form-group">
                                                                            ...
                                                                            <input type="file" name="image"
                                                                                id="menu-file" class="form-control-file"
                                                                                value="{{ $menu->image }}">
                                                                            @error('image')
                                                                                <div class="text-danger">
                                                                                    {{ $message }}
